...
import { useCustomerLoginViewModel } from '../viewmodel/useCustomerLoginViewModel'
import { useNavigate } from 'react-router-dom'

export default function CustomerLoginView() {
  const { form, error, loading, onFieldChange, onSubmit } = useCustomerLoginViewModel()
    ...
    <div className="h-full w-full flex items-center justify-center bg-[#0A0A0A]">
      <div className="w-full max-w-md">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="text-sm text-[#666666] mt-1">Track and manage your bookings</p>
        </div>
